...
export default function NifRegistroPage() {
  ...
  useEffect(() => {
    ...
    void fetch("/api/nif/registro/intento", {
      method: "POST",
    ...
    <>
      ...
      <main className="min-h-screen overflow-x-hidden bg-[#090b0d] text-white">
        <div className="flex flex-col items-center justify-center gap-3 border-b border-white/10 bg-[#12121a] px-4 py-3 text-center text-[11px] font-black uppercase tracking-[0.12em] text-white sm:flex-row sm:justify-between sm:px-8 sm:text-sm">
          ...
          <button
            ...
            className="nif-button rounded-full bg-white px-4 py-2 text-[10px] font-black uppercase tracking-[0.08em] text-[#090b0d] transition hover:bg-[#d8d4ff] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#9b8cff] sm:px-5 sm:text-xs"
          >
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-10 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-12 lg:py-20">
            <div className="nif-reveal">
              ...
              <div className="mt-7 grid gap-3 text-sm font-black uppercase tracking-[0.08em] sm:grid-cols-3">
                ...
                <div className="rounded-xl border border-[#8d7dff]/50 bg-[#7c42ff]/15 p-4 text-[#c9c2ff]">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <p className="text-xs font-bold uppercase tracking-[0.14em] text-white/55">
                  Paso 1 de 2 · Deja tus datos y después completa tu acceso
                  entrando al grupo oficial de WhatsApp.
                </p>
              </div>
            </div>
            ...
            <div className="nif-reveal nif-reveal-delay relative mx-auto hidden w-full max-w-md lg:block">
              ...
              <div className="relative flex min-h-[420px] items-end justify-center">
                <Image
                  src="/alfredo.png"
                  alt="Mtro. Alfredo Cobos, instructor de CEFIN"
                  width={800}
                  height={800}
                  priority
                  sizes="(min-width: 1024px) 40vw, 0px"
                  className="nif-float relative max-h-[560px] h-auto w-full object-contain"
                />
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto max-w-6xl px-5 py-14 sm:px-8 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.25em] text-[#a79bff]">
                Una clase, bases que sí usarás
              </p>
              ...
              <ul className="mt-7 grid gap-4">
                {benefits.map((item) => (
                  <li
                    key={item}
                    className="nif-card rounded-2xl border border-white/10 bg-white/[0.05] p-5 text-base leading-relaxed text-white/80"
                  >
                    <span className="mr-3 text-[#a79bff]">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#111618] p-6 sm:p-8">
              ...
              <ul className="mt-7 grid gap-4">
                {audience.map((item) => (
                  <li
                    key={item}
                    className="nif-card flex gap-3 rounded-xl p-3 text-base leading-relaxed text-white/75"
                  >
                    <span className="mt-1 text-[#a79bff]">→</span>
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <section
          ...
          className="scroll-mt-6 border-y border-white/10 bg-[#f6f8f2] px-5 py-14 text-[#172015] sm:px-8 lg:py-20"
        >
          <div className="mx-auto max-w-2xl">
            <p className="text-xs font-black uppercase tracking-[0.25em] text-[#4d7c18]">
              Paso 1 de 2
            </p>
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-5xl">
              Registra tus datos para apartar tu lugar
            </h2>
            <p className="mt-4 leading-relaxed text-[#41503e]">
              Completa el formulario para guardar tus datos.
            </p>
            <p className="mt-2 leading-relaxed text-[#41503e]">
              Al terminar, te enviaremos al último paso: entrar al grupo oficial
              de WhatsApp, donde recibirás el acceso, los recordatorios y los
              avisos de la clase.
            </p>
            <p className="mt-8 text-center text-sm font-black uppercase tracking-[0.2em] text-[#4d7c18]">
              Completa el formulario ahora
            </p>
            <div className="mt-5 rounded-3xl bg-white p-5 shadow-xl sm:p-8">
              <div className={`${FORM_CLASS} min-h-[440px]`} />
            </div>
            <p className="mt-5 text-sm font-bold leading-relaxed text-[#8b3d15]">
              Importante: después de enviar tus datos, todavía deberás entrar al
              grupo oficial de WhatsApp para completar tu acceso.
            </p>
            <p className="mt-5 text-xs leading-relaxed text-[#596455]">
              Al registrarte aceptas recibir información relacionada con esta
              clase y reconoces nuestro aviso de privacidad.
            </p>
          </div>
        </section>
        ...
        <section className="relative overflow-hidden bg-[linear-gradient(135deg,#3156ff_0%,#7c42ff_100%)] px-5 py-14 text-white sm:px-8 lg:py-20">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-black tracking-tight sm:text-5xl">
              No sigas interpretando reportes sin entender la lógica detrás de
              los números
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-white/80">
              Fortalece tus bases en las NIF y aprende a leer información
            ...
            <button
              type="button"
              onClick={scrollToForm}
              className="nif-button mt-8 inline-flex min-h-[56px] w-full items-center justify-center rounded-2xl bg-white px-7 py-4 text-sm font-black uppercase text-[#11131a] transition hover:bg-[#e7e3ff] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white sm:w-auto sm:text-base"
            >
              ¡Quiero mi lugar gratis!
            </button>
            <p className="mt-4 text-xs font-bold uppercase tracking-[0.12em] text-white/70">
              Solo toma un momento. Después completarás tu acceso en WhatsApp.
            </p>
          </div>
        </section>
      </main>
      ...
      <style jsx global>{`
        ...
        .${FORM_CLASS} textarea {
          ...
          border: 1px solid #dbe2d8 !important;
        ...
        .${FORM_CLASS} button[type="submit"] {
          ...
          background: linear-gradient(90deg, #3156ff, #7c42ff) !important;
          ...
          box-shadow: 0 12px 30px rgba(49, 86, 255, 0.25) !important;
        }
        .nif-button {
        ...
        .nif-button:hover {
          ...
          box-shadow: 0 20px 55px rgba(124, 66, 255, 0.3);
        }
        .nif-card {
          transition:
            transform 0.3s ease,
        ...
        .nif-card:hover {
          ...
          border-color: rgba(167, 155, 255, 0.38);
          background-color: rgba(255, 255, 255, 0.08);
        }
        .nif-reveal {
          animation: nif-reveal 0.7s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        .nif-reveal-delay {
          animation-delay: 0.12s;
        }
        .nif-float {
          animation: nif-float 6s ease-in-out infinite;
        }
        .nif-orb {
          animation: nif-orb 9s ease-in-out infinite alternate;
        }
        .nif-orb-delay {
          animation-delay: -3s;
        }
        .nif-glow {
          animation: nif-glow 5s ease-in-out infinite alternate;
        }
        .nif-cta-shine {
          animation: nif-float 8s ease-in-out infinite;
        }
        @keyframes nif-reveal {
          from {
            opacity: 0;
