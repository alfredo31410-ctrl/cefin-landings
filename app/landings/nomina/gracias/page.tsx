...
export const metadata: Metadata = {
  ...
  description:
    "Confirma tu registro al reto gratuito de nómina en vivo de CEFIN.",
...
export default function NominaGraciasPage() {
  const { thankYou, instructor, eventType, dates, time, timezone, platform } =
    config;
    ...
    <>
      <main className="nomina-thankyou-page">
        ...
        <header className="thankyou-header">
          <Link
            href="/landings/nomina"
            className="thankyou-brand"
            aria-label="CEFIN, volver a la landing del reto"
          >
        ...
        <section className="thankyou-shell" aria-labelledby="thankyou-title">
          <div className="thankyou-card">
            ...
            <p className="thankyou-lede">
              ...
              oficial para recibir los enlaces de las sesiones, recordatorios y
              avisos importantes.
            </p>
            <p className="thankyou-status">
              Tu registro está guardado, pero el proceso todavía no está
              completo.
            </p>

            {thankYou.whatsappEnabled ? (
              <div className="thankyou-action">
                <NominaWhatsAppIntentLink
                  className="thankyou-cta"
                  href={thankYou.whatsappRedirectPath}
                >
                  ENTRAR AL GRUPO OFICIAL <span aria-hidden="true">→</span>
                </NominaWhatsAppIntentLink>
                <p>
              ...
              <div className="thankyou-pending" role="status">
                <p className="thankyou-pending-title">
                  Estamos preparando el acceso al grupo
                </p>
                <p>
                  El enlace oficial todavía no ha sido configurado. No abras
                  registros al público hasta completar este paso.
                </p>
              </div>
            )}
            ...
            <div className="thankyou-columns">
              <div>
                ...
                <ul className="thankyou-benefits">
        ...
        <footer className="thankyou-footer">
          CEFIN · Registro guardado · Sin tracking activo
        </footer>
      </main>
