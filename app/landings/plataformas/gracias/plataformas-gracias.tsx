...
function InvalidRegistration() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-black px-5 py-12 text-white">
      <div className="w-full max-w-xl rounded-[2rem] border border-white/10 bg-white/[0.06] p-8 text-center shadow-[0_30px_100px_rgba(0,0,0,.55)]">
        ...
        <a
          ...
          className="mt-7 inline-flex min-h-12 items-center justify-center rounded-full bg-white px-7 text-sm font-black uppercase text-black"
        >
          Volver al registro
        </a>
      </div>
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-black text-white">
        ...
        <section className="relative z-20 mx-auto grid min-h-screen max-w-[1320px] items-center gap-8 px-5 py-8 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:px-12">
          <div className="max-w-4xl">
            ...
            <div
              className="mt-8 inline-flex min-h-20 w-full items-center justify-center gap-3 rounded-[1.6rem] border border-lime-300/35 bg-lime-300/10 px-7 text-center text-base font-black uppercase text-lime-200 shadow-[0_0_45px_rgba(163,230,53,.14)] sm:w-auto sm:px-10 sm:text-lg"
              role="status"
            >
              <svg
              ...
              <span>Grupo de WhatsApp pendiente de habilitar</span>
            </div>
            ...
            <p className="mt-4 max-w-2xl text-sm font-black uppercase tracking-[0.16em] text-lime-200">
              El acceso al grupo se integrará cuando el enlace oficial esté
              disponible.
            </p>
