  ...
  return (
    <>
      ...
      <main className="cuentas-landing overflow-x-hidden bg-[#031a36] text-white">
        ...
        {/* Escalamiento: siguiente paso en la formación contable */}
        <section className="bg-[#f3f0e8] text-[#071a3f]">
          <div className="mx-auto max-w-[1160px] px-5 py-20 sm:px-8 lg:px-10 lg:py-24">
            ...
            <h2 className="mt-4 text-center text-4xl font-black sm:text-5xl">
              Continúa dominando la contabilidad desde cero.
            </h2>

            <div className="relative mt-12 overflow-hidden border border-[#b88828]/30 bg-[#061f3e] p-7 text-white sm:p-10">
              <div className="gold-grid absolute inset-0 opacity-10" />

              <div className="relative grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
                <div className="flex justify-center">
                  <div className="flex h-52 w-52 flex-col items-center justify-center rounded-full border-4 border-[#e5b84b] bg-[#03152d] text-center shadow-[0_20px_50px_rgba(0,0,0,.25)]">
                    <p className="text-xs font-black uppercase tracking-[0.2em] text-[#e5b84b]">
                      Academia
                    </p>

                    <p className="mt-2 text-4xl font-black">CEFIN</p>

                    <p className="mt-2 max-w-[150px] text-xs uppercase text-white/55">
                      Contabilidad básica con IA
                    </p>
                  </div>
                </div>

                <div>
                  <p className="text-sm font-black uppercase tracking-[0.2em] text-[#e5b84b]">
                    Tu siguiente paso
                  </p>

                  <h3 className="mt-4 text-3xl font-black sm:text-4xl">
                    Academia CEFIN de Contabilidad Básica con IA
                  </h3>

                  <p className="mt-5 max-w-2xl leading-relaxed text-white/65">
                    Profesionaliza tus conocimientos y domina la contabilidad
                    desde cero con acompañamiento, plantillas, inteligencia
                    artificial y casos prácticos.
                  </p>
                  ...
                  <div className="mt-7 grid gap-3 sm:grid-cols-3">
                    {[
                      ...
                      <div
                        key={item}
                        className="border border-[#e5b84b]/20 bg-white/[0.04] p-4 text-sm font-bold"
                      >
                        {item}
                      </div>
                    ))}
