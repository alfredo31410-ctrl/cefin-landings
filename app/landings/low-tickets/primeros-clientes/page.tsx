...
const PRICE = 297;
const CHECKOUT_URL =
  "https://pay.hotmart.com/O105077745K?off=60uw7x37&checkoutMode=10";
...
const outcomes = [
  [
    ...
    "Deja de hablarle a todos e identifica a quién puedes ayudar mejor.",
  ],
  [
    "02",
    "Presenta tus servicios",
    "Explica lo que haces de forma clara, profesional y fácil de valorar.",
  ],
  [
    "03",
    "Inicia conversaciones",
    "Usa mensajes prácticos para contactar prospectos sin sentirte invasivo.",
  ],
  [
    "04",
    "Da seguimiento",
    "Mantén vivas las oportunidades sin perseguir ni presionar a nadie.",
  ],
  [
    "05",
    "Convierte con criterio",
    "Lleva cada conversación hacia una propuesta y un siguiente paso concreto.",
  ],
  [
    "06",
    "Crea un sistema",
    "Deja de depender únicamente de recomendaciones o de la suerte.",
  ],
];
...
const audience = [
  ...
  "Ya tienes despacho, pero todavía tienes pocos clientes.",
...
const roadmap = [
  [
    "Punto de partida",
    "Define qué servicio ofrecer y qué problema puedes resolver.",
  ],
  [
    "Prospectos correctos",
    "Identifica personas y empresas con mayor posibilidad de necesitarte.",
  ],
  [
    "Mensaje inicial",
    "Aprende qué decir para abrir una conversación profesional.",
  ],
  [
    "Presentación",
    "Comunica tu servicio desde el valor, no desde una lista de tareas.",
  ],
  [
    "Seguimiento",
    "Aprende cuándo volver a escribir y cómo mantener el interés.",
  ],
  [
    "Conversión",
    "Convierte una conversación en una oportunidad comercial real.",
  ],
];
...
const faqs = [
  {
    ...
    answer:
      "No. La guía está pensada para contadores que quieren comenzar con una ruta clara, sencilla y aplicable.",
  },
  {
    question: "¿Esto funciona si todavía no tengo despacho?",
    answer:
      "Sí. Puedes usarla para validar tus primeros servicios y comenzar a construir una cartera de clientes antes de independizarte por completo.",
  },
  {
    ...
    <>
      ...
      <main className="landing overflow-x-hidden bg-[#05070a] text-white">
            ...
            <div className="grid flex-1 items-center gap-3 py-8 lg:grid-cols-[0.92fr_1.08fr] lg:py-0">
              ...
              <div className="reveal delay-2 order-1 text-center lg:order-2 lg:pl-8 lg:text-left">
                ...
                <h1 className="mt-4 text-[clamp(3.3rem,8vw,7.4rem)] font-black leading-[0.82] tracking-normal">
                  ...
                  <span className="mt-3 block text-[.55em] leading-none text-white">
                    contables
                  </span>
                </h1>

                <p className="mx-auto mt-7 max-w-[680px] text-base leading-relaxed text-white/72 sm:text-xl lg:mx-0">
                  Una guía práctica para atraer, contactar y convertir
                  prospectos en clientes de tu despacho contable.
                </p>
          ...
          <div className="mx-auto grid max-w-[1180px] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[.85fr_1.15fr] lg:items-center lg:px-10 lg:py-28">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-black/65">
                Si quieres conseguir clientes, pero no sabes cómo buscarlos,
                esta guía te ayuda a convertir la incertidumbre en acciones
                concretas.
              </p>
            </div>
            ...
            <div className="relative border-l border-black/15 pl-6 sm:pl-10">
              ...
              <p className="text-sm font-black uppercase tracking-[0.18em] text-[#078fd1]">
                A tener
              </p>

              <p className="mt-3 text-2xl font-black leading-tight sm:text-4xl">
                Una ruta clara para contactar prospectos, presentar tus
                servicios y conseguir tus primeros clientes contables.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="relative mx-auto max-w-[1240px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-white/60">
                Aprende el proceso completo para crear oportunidades sin dejar
                de ser contador.
              </p>
            </div>
            ...
            <div className="mt-14 grid border-l border-t border-white/10 sm:grid-cols-2 lg:grid-cols-3">
              {outcomes.map(([number, title, text]) => (
                ...
                >
                  <p className="text-sm font-black tracking-[0.2em] text-[#21bfff]">
                    {number}
                  </p>

                  <h3 className="mt-10 text-2xl font-black transition group-hover:text-[#32c7ff]">
                    {title}
                  </h3>
        ...
        <section className="relative overflow-hidden bg-[#07131d]">
          ...
          <div className="relative mx-auto max-w-[1160px] px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
            <div className="grid items-center gap-8 border border-white/15 bg-white/[0.04] p-7 backdrop-blur-md sm:p-10 lg:grid-cols-[1fr_auto] lg:gap-12">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#32c7ff]">
                  Ya conoces la ruta
                </p>

                <h2 className="mt-3 max-w-3xl text-3xl font-black leading-tight sm:text-5xl">
                  Ahora conviértela en acción y consigue tus primeros clientes.
                </h2>

                <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/65 sm:text-lg">
                  Obtén una guía práctica para dejar de depender únicamente de
                  recomendaciones y comenzar a generar oportunidades reales para
                  tu despacho.
                </p>
              </div>
              ...
              <div className="flex flex-col items-start lg:items-end">
                ...
                <p className="mt-3 text-xs font-bold uppercase tracking-[0.12em] text-white/40">
        ...
        <section id="comprar" className="relative overflow-hidden bg-[#05070a]">
          ...
          <div className="relative mx-auto max-w-[1050px] px-5 py-20 text-center sm:px-8 lg:py-28">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-white/58">
              ...
              para encontrar prospectos y convertir oportunidades.
            </p>
              ...
              {faqs.map((faq) => (
                ...
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-5 text-lg font-black">
                    ...
                    <span className="text-2xl text-[#078fd1] transition group-open:rotate-45">
                      +
                    </span>
                  </summary>
